    ...
    <body onlo id="page-top">
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="text-white mb-4">ASMPIMP E LPD</h2>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <a href="#about">  <button id="btnSpeak" class="btn btn-primary" > <img src="assets/img/question.png" width="20px" height="20px">  Responder Questionário </button> </a> 
                </div>  
                </center>
