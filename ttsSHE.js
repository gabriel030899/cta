...
btnSpeak.addEventListener('click', () => {
  ...
  msg.text = ".. As Ferramentas que compõem o pilar de chii são fundamentais e de grande importância para o ambiente de trabalho, selecione um dos itens e venha comigo!!";
